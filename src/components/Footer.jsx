        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">Business Solutions</span>
            </div>
            <p className="text-gray-400 text-sm">
              Your trusted partner for comprehensive business process outsourcing services.
              We help businesses streamline operations and achieve growth.
            </p>
          </div>
              ...
              {socialLinks.map((social) => (
                <a
                  ...
                  className={`w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center hover:bg-primary-600 transition-colors ${
                    social.name === 'WhatsApp' ? 'hover:bg-green-500' : ''
                  }`}
